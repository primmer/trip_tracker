...
Consider but don't implement yet, adding videos to the media shown. There are several trips that have videos taken the same day.

## Sourcecode and dev

Use a local JJ repository for now and we will eventually put it in a private github.
